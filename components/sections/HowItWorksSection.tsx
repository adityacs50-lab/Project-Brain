  ...
  return (
    <section id="how-it-works" className="bg-[#050505] py-24 sm:py-28 md:py-36 px-6 sm:px-8 border-t border-white/5">
      <div className="max-w-6xl mx-auto">
        ...
        <div ref={gridRef} className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
          ...
          {steps.map((step, idx) => (
            ...
            >
              <motion.div
                ...
                transition={{ duration: 0.5, delay: idx * 0.18 + 0.15, ease: EASE }}
                className="w-16 h-16 rounded-2xl bg-white/[0.03] border border-white/10 flex items-center justify-center mb-8 relative z-10 group-hover:border-[#10b981]/30 transition-colors duration-500"
              >
